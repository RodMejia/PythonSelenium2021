...
from Modulo6.src.elements.inventory_items import InventoryItems
from Modulo6.src.elements.menu import Menu
from Modulo6.src.elements.select_element import SelectElement
from Modulo6.src.locators.inventory import InventoryPageLoc
